...
// import { imgBg1, imgBg2, imgBg3 } from 'webapp/images/slides';
...
const HeroMarketing = () => (
        <div id="rev_slider_1014_1_wrapper" className="rev_slider_wrapper fullscreen-container" data-alias="typewriter-effect" data-source="gallery" style={{ backgroundColor: '#141E30', padding: '0px' }}>
            <div id="rev_slider_1014_1" className="rev_slider fullscreenbanner" style={{ display: 'none' }} data-version="5.4.1">
                <ul>
                    <li
                        ...
                        data-description=""
                    >
                        <img src={imgBg1} alt="" data-bgposition="center center" data-bgfit="cover" className="rev-slidebg" data-no-retina />
                        ...
                        <div
                            ...
                            style={{
                                zIndex: '7',
                                backgroundColor: 'rgba(245, 50, 92, 1.00)',
                                borderColor: 'rgba(0, 0, 0, 0)',
                                borderWidth: '0px',
                            }}
                        ></div>
                    ...
                    <li
                        ...
                        data-description=""
                    >
                        <img src={imgBg2} alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" className="rev-slidebg" data-no-retina />
                        <div
                            className="tp-caption tp-shape tp-shapewrapper "
                    ...
                    <li
                        ...
                        data-description=""
                    >
                        <img src={imgBg3} alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" className="rev-slidebg" data-no-retina />
                        <div
                            className="tp-caption tp-shape tp-shapewrapper "
