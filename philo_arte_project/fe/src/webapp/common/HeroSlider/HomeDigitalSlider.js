...
import img1 from "webapp/images/slides/home-bg-9.jpg"
import img2 from "webapp/images/slides/home-bg-10.jpg"
import img3 from "webapp/images/slides/home-bg-11.jpg"

const HomeDigitalSlider = () => (
  <section className="remove-padding transition-none" id="home">
    <div
      id="rev_slider_1078_2_wrapper"
    ...
    >
      <div
        id="rev_slider_1078_2"
        className="rev_slider fullwidthabanner anno-rs"
        style={{ display: "none" }}
        data-version="5.4.1"
      >
        <ul>
          ...
          >
            ...
            <div className="hero-text-wrap">
              ...
              >
                Superb Template for <br />
                Startups <span className="text-bottom-line">Business</span>
              </div>
              ...
              >
                A startup company, or simply a startup, is an entrepreneurial
                venture
                <br /> in its early stages of operations typically aimed at
                resolving
                <br /> a real life issue with an innovative product or service.
              </div>
...
export default HomeDigitalSlider;
