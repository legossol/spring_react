        ...
        <Grid item xs={12} sm={4}>
          <Card className={classes.card}>
            <CardMedia
              ...
              image="https://shop.westpointhistoryofwarfare.com/spree/products/94/product/cover_USMA-HI301.jpg?1504823724"
            ...
            <CardContent className={classes.content}>
              ...
              >
                <span
                  class="mdi mdi-gesture-double-tap"
                  style={{ fontSize: "28px" }}
                >
                  &nbsp;
                </span>
        ...
        <Grid item xs={12} sm={8}>
          <Box className={classes.box}>
            ...
            <Typography variant="body1" color="textSecondary" component="p">
              <p>
                The West Point History of the American Revolution is the latest
                volume from the West Point History of Warfare.
              </p>
              <p>
                This new volume offers a groundbreaking view of this
                foundational war. With a host of new, custom built digital
                features - including in-depth animated campaign maps,
                interactive data visualizations, in-depth detail on period
                propaganda, battle songs and lyrics, soldier hotspot
                interactives, expandable biographies, historical on-the-ground
                accounts, and precise battle maps - this interactive text offers
                a view of the war that has truly never been seen before.
              </p>
              <p>
                As the New York Journal of Books states, the book "sets the
                standard for a single volume military history text on the
                American Revolution." And the digital features only add to this
                exceptional standard. Over six comprehensive chapters, the book
                outlines all aspects of the war, from the pre-war tensions and
                conflicts to the post-war survival of a nation state.
              </p>
              <p>
                This digital text is available across all platforms on Windows,
          ...
          <Box className={classes.box}>
            ...
            >
              <p>
                ...
                There are truly not enough superlatives to describe this volume.
                . . . To accompany each chapter, the text provides lavish maps,
                timelines, figures, and order-of-battle diagrams for each of the
                major battles and campaigns. While these would be expected from
                a military history text, they are nonetheless extremely well
                done . . . While intended to serve as an undergraduate textbook,
                there is a great deal of scholarship to unpack from this text,
                even for the experienced student of World War II. . . . This is
                a truly magnificent volume that should become not only standard
                issue at West Point but for any university teaching an
                undergraduate course in World War II.
            ...
            >
              <p>
                <span class="mdi mdi-format-quote-open"> </span>A digital
                revolution has altered the way today's students experience
                the...'History of the Military Art,' thanks to a unique
                entrepreneurial venture between the United States Military
                Academy at West Point and Rowan Technology.
                <span class="mdi mdi-format-quote-close"> </span>
              </p>
            </Typography>
            <Typography
            ...
            >
              <p>
                <span class="mdi mdi-format-quote-open"> </span>
                We were blown away by the breadth and depth of material as well
                the eye-popping art direction. The print edition is as good as
                any Civil War anthology we've ever seen, while the digital
                version pushes the publishing envelope with the fully animated
                battle maps, data-rich info graphics, diagrams, photo libraries
                and a host of multimedia features. Regardless of the format,
                this collection is a must-have for any student of the American
                Civil War.
                <span class="mdi mdi-format-quote-close"> </span>
              </p>
            </Typography>
